...
- (void)viewDidLoad {
    ...
    LrdCellModel *one1 = [[LrdCellModel alloc] initWithTitle:@"附近学校" imageName:@"item_school"];
    LrdCellModel *two1 = [[LrdCellModel alloc] initWithTitle:@"联赛流程" imageName:@"item_battle"];
    LrdCellModel *three1 = [[LrdCellModel alloc] initWithTitle:@"其他联赛" imageName:@"item_list"];
    LrdCellModel *four1 = [[LrdCellModel alloc] initWithTitle:@"校内群聊" imageName:@"item_chat"];
    LrdCellModel *five1 = [[LrdCellModel alloc] initWithTitle:@"邀请好友" imageName:@"item_share"];
    self.dataArr = @[one, two, three, four, five,one1, two1, three1, four1, five1];
